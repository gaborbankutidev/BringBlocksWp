...
class Config {
	...
	public static function get_supported_post_types($without_bring_post_types = false) {
		$bring_post_types = $without_bring_post_types
			? []
			: ["bring_header", "bring_footer", "bring_layout"]; // can not be removed

		$bring_custom_post_types = apply_filters("bring_blocks_post_types", ["post", "page"]);
	...
	public static function get_layout_taxonomies() {
		return apply_filters("bring_blocks_layout_taxonomies", ["category", "post_tag"]);
	}
